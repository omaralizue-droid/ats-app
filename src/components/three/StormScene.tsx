...
export default function StormScene({ className = '', overlayOpacity = 0.45 }: StormSceneProps) {
  ...
  useEffect(() => {
    ...
    const stormPts = new THREE.Points(stormGeo, stormMat)
    ...
    const atmoMat = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uRes: { value: new THREE.Vector2(W * window.devicePixelRatio, H * window.devicePixelRatio) },
      },
      vertexShader: `
  ...
  return (
    <div className={`relative h-full w-full overflow-hidden ${className}`}>
      <div ref={mountRef} className="absolute inset-0 h-full w-full pointer-events-auto" />
      <div
        className="absolute inset-0 pointer-events-none bg-gradient-to-b from-transparent via-[#03030c]/30 to-[#03030c]"
